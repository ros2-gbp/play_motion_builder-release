...
%global pkg_name play_motion_builder
%global normalized_pkg_name %{lua:return (string.gsub(rpm.expand('%{pkg_name}'), '_', '-'))}

Name:           ros-lyrical-play-motion-builder
Version:        1.4.1
Release:        3%{?dist}
...
%changelog
* Wed Apr 29 2026 davidfernandez <david.fernandez@pal-robotics.com> - 1.4.1-3
- Autogenerated by Bloom

* Tue Apr 28 2026 davidfernandez <david.fernandez@pal-robotics.com> - 1.4.1-2
- Autogenerated by Bloom

* Tue Apr 21 2026 davidfernandez <david.fernandez@pal-robotics.com> - 1.4.1-1
- Autogenerated by Bloom
